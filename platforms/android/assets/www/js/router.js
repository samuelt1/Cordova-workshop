window.Router = Backbone.Router.extend({
  routes: {
    ...
    'virtual-reality': 'showVirtualReality',
    'website': 'showWebsite',
    // pages
    ...
    'locations/:h_id/:c_id': 'showLocationsByCategory',
    'locations/:h_id/:c_id/:place_id': 'showLocation',
    'contact/:h_id/department': 'showDepartmentContact',
    'contact/:h_id/clinic': 'showClinicContact',
    'contact/:h_id/clinic/transportation': 'showClinicTransportationMap',
    'contact/:h_id/clinic/floors': 'showClinicFloorMaps',
    'contact/:h_id/clinic/floors/:id': 'showClinicFloorMap',
    'contact/:h_id/clinic/directions': 'showClinicDirections',
    'contact/:h_id/hospital': 'showHospitalContact',
    'contact/:h_id/hospital/transportation': 'showHospitalTransportationMap',
    'contact/:h_id/hospital/floors': 'showHospitalFloorMaps',
    'contact/:h_id/hospital/floors/:id': 'showHospitalFloorMap',
    'contact/:h_id/hospital/directions': 'showHospitalDirections',
    'contact/:h_id/social-media': 'showSocialMediaContact',
    'virtual-reality/:v_id': 'showVideo',
